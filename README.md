...
{
	Lcd_cursor(&lcd, 0,1);
	Lcd_string(&lcd, "VASANTH.V \n");
	Lcd_cursor(&lcd, 1,1);
	Lcd_string(&lcd, "2305002027 \n");
	for(int x=0;x<100;x++)
	{
		Lcd_cursor(&lcd,1,1);
		Lcd_int(&lcd,x);
...
## Output screen shots of proteus  :
 ...
 ![3520c7e3-b443-425f-9879-24312632f3cf](https://github.com/user-attachments/assets/abd3923c-826c-4d2a-afdd-990b04051dfb)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![368825313-7e1f59dd-df75-40e5-bdc0-4fa1eda6bd5c](https://github.com/user-attachments/assets/7707db1d-e68d-462b-8fe9-e6e433d75c96)
